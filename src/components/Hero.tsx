...
const Hero: React.FC<HeroProps> = ({ onBuyClick }) => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-b from-[#050B14]/40 via-transparent to-[#050B14] z-0"></div>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center text-center mt-12">
        ...
        <h1 
          ref={titleRef} 
          className="invisible font-serif text-[clamp(2rem,7vw,4.5rem)] md:text-6xl lg:text-7xl font-bold tracking-wider leading-none mb-6 drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] text-white"
        >
        ...
        <p 
          ref={subtitleRef} 
          className="opacity-0 translate-y-4 max-w-2xl text-white/85 text-sm md:text-base leading-relaxed tracking-wide drop-shadow-md mb-6 pointer-events-auto"
        >
        ...
        <div 
          ref={priceBadgeRef} 
          className="opacity-0 translate-y-4 mb-8 py-2 px-5 bg-gradient-to-r from-[#F5E6C8]/10 to-[#00F0FF]/15 border border-[#00F0FF]/25 backdrop-blur-md rounded-sm inline-flex items-center gap-2.5 shadow-[0_0_20px_rgba(0,240,255,0.05)]"
        >
          <span className="text-[11px] md:text-xs font-semibold tracking-wider text-[#F5E6C8] uppercase">Special Direct Launch:</span>
          <span className="text-sm md:text-base font-bold text-[#00F0FF] font-serif">₹224</span>
          <span className="text-[10px] md:text-xs text-white/40 line-through">MRP ₹1,149</span>
          <span className="text-[10px] md:text-xs bg-[#00F0FF]/20 text-[#00F0FF] px-1.5 py-0.5 rounded font-bold">81% Off</span>
        </div>
        ...
        >
          <button 
            ref={orderBtnRef}
            onClick={onBuyClick}
            className="w-full sm:w-auto bg-[#00F0FF] text-[#050B14] hover:bg-white hover:text-[#050B14] transition-all duration-300 py-4 px-10 tracking-[0.15em] text-xs font-extrabold rounded-sm shadow-[0_0_25px_rgba(0,240,255,0.25)] hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] hover:scale-105"
          >
            ORDER VIA WHATSAPP
          </button>
        ...
        >
          <div className="flex items-center gap-1.5 py-1.5 px-3 bg-white/[0.02] border border-white/[0.05] rounded-full">
