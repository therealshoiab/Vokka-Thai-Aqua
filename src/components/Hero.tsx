  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center text-center mt-12">
        ...
        <div 
          ref={eyebrowRef} 
          className="opacity-0 translate-y-4 text-[#D4AF37] tracking-[0.3em] text-[10px] md:text-xs font-bold uppercase mb-4 py-1.5 px-4 bg-[#D4AF37]/5 border border-[#D4AF37]/20 backdrop-blur-md rounded-full shadow-[0_0_15px_rgba(212,175,55,0.05)]"
        >
          ✦ LUXURY EAU DE PARFUM • 100ML
        </div>
        
        {/* Title: Plain white text with high readability shadow */}
        <h1 
          ref={titleRef} 
        ...
        >
          ...
          <span className="text-white">ANDAMAN SEA.</span>
        </h1>
        
        {/* Subtitle */}
        <p 
          ref={subtitleRef} 
          className="opacity-0 translate-y-4 max-w-2xl text-white text-sm md:text-base leading-relaxed tracking-wide mb-8 pointer-events-auto text-shadow-premium font-medium"
        >
        ...
        <div 
          ref={priceBadgeRef} 
          className="opacity-0 translate-y-4 mb-8 py-2 px-5 bg-[#050B14]/40 border border-[#D4AF37]/35 backdrop-blur-md rounded-sm inline-flex items-center gap-2.5 shadow-[0_0_20px_rgba(212,175,55,0.05)]"
        >
          <span className="text-[11px] md:text-xs font-semibold tracking-wider text-[#F5E6C8] uppercase">Special Direct Launch:</span>
          <span className="text-sm md:text-base font-bold text-[#D4AF37] font-serif">₹600</span>
          <span className="text-[10px] md:text-xs text-white/40 line-through">MRP ₹2,999</span>
          <span className="text-[10px] md:text-xs bg-[#D4AF37]/20 text-[#D4AF37] px-1.5 py-0.5 rounded font-bold">80% Off</span>
        </div>
        ...
        >
          <button 
            ...
            className="w-full sm:w-auto bg-[#D4AF37] text-[#050B14] hover:bg-white hover:text-[#050B14] transition-all duration-300 py-4 px-10 tracking-[0.15em] text-xs font-extrabold rounded-sm shadow-[0_0_25px_rgba(212,175,55,0.25)] hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] hover:scale-105"
          >
            ORDER VIA WHATSAPP
          </button>
          ...
          <button 
            ...
            className="w-full sm:w-auto border border-white/20 hover:border-[#D4AF37] hover:bg-white/[0.03] transition-all duration-300 py-4 px-10 tracking-[0.15em] text-xs font-bold rounded-sm text-white"
          >
            EXPLORE NOTES ↓
          </button>
        </div>
